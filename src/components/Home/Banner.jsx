        ...
        <SwiperSlide>
          <div className="">
            <div className="relative">
              ...
              <div className="lg:flex justify-between items-center top-0 h-full px-[40px] absolute">
                <div className="lg:w-[60%] flex-col justify-center">
                  <h1 className="lg:text-[64px] text-[25px] text-white">
                    Bandon Electronics and Lighting Store
                  </h1>
                  <p className="text-[15px] lg:mt-[20px] lg:w-[60%] text-white">
